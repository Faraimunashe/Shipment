    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Shipments In Warehouse</h5>
                                ...
                                @foreach ($shipments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCourier{{ $item->id }}"><i class="bi bi-arrow-left-right"></i></button>
                                        </td>
                                        <!-- Add Shipment Modal -->
                                        ...
                                        <!-- Add Courier Modal -->
                                        <div class="modal fade" id="addCourier{{ $item->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form action="{{ route('consigner-add-courier') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="shipment_id" value="{{ $item->id }}" required>
                                                        <div class="modal-header">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select name="courier_id" class="form-control" required>
                                                                        <option selected disabled>Select Delivery Courier</option>
                                                                        @foreach (\App\Models\Courier::all() as $cor)
