    ...
    <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Consigner</li>
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Add Consigner Details</h5>
                    ...
                    @endif
                <!-- Horizontal Form -->
                <form action="{{ route('consigner-add-details') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="regnum" class="form-control" id="inputText" required>
                        </div>
                    </div>
                    <div class="row mb-3">
